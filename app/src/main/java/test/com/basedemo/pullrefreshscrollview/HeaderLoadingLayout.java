...
public class HeaderLoadingLayout extends LoadingLayout {
    ...
    protected View createLoadingView(Context context, AttributeSet attrs) {
        View container = LayoutInflater.from(context).inflate(R.layout.cu_pull_to_refresh_header, null);
        return container;
    }
    ...
    protected void onReset() {
        ...
        mHintTextView.setText(R.string.cu_pull_to_refresh_header_hint_normal);
    }
    ...
    protected void onReleaseToRefresh() {
        ...
        mHintTextView.setText(R.string.cu_pull_to_refresh_header_hint_ready);
    }
    ...
    protected void onRefreshing() {
        ...
        mHintTextView.setText(R.string.cu_pull_to_refresh_header_hint_loading);
    }
}
